...
public class RegistoFaturaImpl implements RegistoFaturaPortType{
	...
	public Serie pedirSerie(int nifEmissor) throws EmissorInexistente_Exception {
		...
		try {
			Connection conn =  (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/regfatdb", "regfatdbuser", "regfatdbpass");
	...
	public void comunicarFatura(Fatura parameters)
		...
		String insert = "INSERT INTO FATURA (SERIE_NUM, DATA_EMISSAO, SEQ_NUM, NIF_EMISSOR, NIF_CLIENTE, IVA_FATURA, ANO) VALUES(?,?,?,?,?,?,?)";
