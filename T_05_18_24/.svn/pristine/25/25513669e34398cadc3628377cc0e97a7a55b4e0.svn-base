...
public class RestSetup {
    ...
    public static void populateDomain() {
		...
		Cliente c1 = new Cliente("Zé Ninguém", "zeze", "z3z3", "Lisboa, Portugal", "ze.ninguem@ist.utl.pt");
    	...
    	Prato prato1 = new Prato(rest, "Bacalhau com batatas", alimentosPrato1);
    	Prato prato2 = new Prato(rest, "Bitoque", alimentosPrato2);
    	Prato prato3 = new Prato(rest, "Canja de galinha", alimentosPrato3);
    	Prato prato4 = new Prato(rest, "Bacalhau com batatas", alimentosPrato1);
